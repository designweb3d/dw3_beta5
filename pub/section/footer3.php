...
<footer>
    <?php if (!isset($dw3_conn)){header('Location: https://'.$_SERVER["SERVER_NAME"].'/');exit;}?>
        ...
        <div style="margin:-10px 10px 0px 0px;z-index:+1;position:absolute;right:0px;font-size:0.8em;display:inline-block;height:2vw;min-height:40px;overflow:hidden;text-align:right;">
        <?php 
        ...
        <div style='display:block;text-align:center;'>
            <div style='display:inline-block;vertical-align:top;width:auto;text-align:center;padding-top:40px;'>
                <span style="font-size:35px;vertical-align:middle;">&#128339;</span> 
                    <?php 
                    $is_open = false;
                ...
                if($USER_LANG == "FR"){ ?><br>
                    <table style='width:360px;margin-left:auto; margin-right:auto;'>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Lundi</td>   <td <?php if ($CIE_OPEN_J1_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J1_FR;} else if ((strtotime($CIE_OPEN_J1_H1)-strtotime($CIE_OPEN_J1_H2)>=0) && (strtotime($CIE_OPEN_J1_H3)-strtotime($CIE_OPEN_J1_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J1_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J1_H2,0,5); if (strtotime($CIE_OPEN_J1_H3)-strtotime($CIE_OPEN_J1_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J1_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J1_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Mardi</td>   <td <?php if ($CIE_OPEN_J2_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J2_FR;} else if ((strtotime($CIE_OPEN_J2_H1)-strtotime($CIE_OPEN_J2_H2)>=0) && (strtotime($CIE_OPEN_J2_H3)-strtotime($CIE_OPEN_J2_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J2_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J2_H2,0,5); if (strtotime($CIE_OPEN_J2_H3)-strtotime($CIE_OPEN_J2_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J2_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J2_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Mercredi</td><td <?php if ($CIE_OPEN_J3_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J3_FR;} else if ((strtotime($CIE_OPEN_J3_H1)-strtotime($CIE_OPEN_J3_H2)>=0) && (strtotime($CIE_OPEN_J3_H3)-strtotime($CIE_OPEN_J3_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J3_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J3_H2,0,5); if (strtotime($CIE_OPEN_J3_H3)-strtotime($CIE_OPEN_J3_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J3_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J3_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Jeudi</td>   <td <?php if ($CIE_OPEN_J4_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J4_FR;} else if ((strtotime($CIE_OPEN_J4_H1)-strtotime($CIE_OPEN_J4_H2)>=0) && (strtotime($CIE_OPEN_J4_H3)-strtotime($CIE_OPEN_J4_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J4_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J4_H2,0,5); if (strtotime($CIE_OPEN_J4_H3)-strtotime($CIE_OPEN_J4_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J4_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J4_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Vendredi</td><td <?php if ($CIE_OPEN_J5_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J5_FR;} else if ((strtotime($CIE_OPEN_J5_H1)-strtotime($CIE_OPEN_J5_H2)>=0) && (strtotime($CIE_OPEN_J5_H3)-strtotime($CIE_OPEN_J5_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J5_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J5_H2,0,5); if (strtotime($CIE_OPEN_J5_H3)-strtotime($CIE_OPEN_J5_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J5_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J5_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Samedi</td>  <td <?php if ($CIE_OPEN_J6_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J6_FR;} else if ((strtotime($CIE_OPEN_J6_H1)-strtotime($CIE_OPEN_J6_H2)>=0) && (strtotime($CIE_OPEN_J6_H3)-strtotime($CIE_OPEN_J6_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J6_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J6_H2,0,5); if (strtotime($CIE_OPEN_J6_H3)-strtotime($CIE_OPEN_J6_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J6_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J6_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Dimanche</td><td <?php if ($CIE_OPEN_J0_FR) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J0_FR;} else if ((strtotime($CIE_OPEN_J0_H1)-strtotime($CIE_OPEN_J0_H2)>=0) && (strtotime($CIE_OPEN_J0_H3)-strtotime($CIE_OPEN_J0_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Fermé";} else { echo "width='10%'>".substr($CIE_OPEN_J0_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J0_H2,0,5); if (strtotime($CIE_OPEN_J0_H3)-strtotime($CIE_OPEN_J0_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J0_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J0_H4,0,5); }} ?></td></tr>
                    </table><br><span style='margin:10px 0px;'>Les heures d'ouvertures peuvent varier durant les jours fériés.</span>
                <?php } else { ?>
                    <br>
                    <table style='width:360px;margin-left:auto; margin-right:auto;'>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Monday</td>   <td <?php if ($CIE_OPEN_J1_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J1_EN;} else if ((strtotime($CIE_OPEN_J1_H1)-strtotime($CIE_OPEN_J1_H2)>=0) && (strtotime($CIE_OPEN_J1_H3)-strtotime($CIE_OPEN_J1_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J1_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J1_H2,0,5); if (strtotime($CIE_OPEN_J1_H3)-strtotime($CIE_OPEN_J1_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J1_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J1_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Tuesday</td>  <td <?php if ($CIE_OPEN_J2_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J2_EN;} else if ((strtotime($CIE_OPEN_J2_H1)-strtotime($CIE_OPEN_J2_H2)>=0) && (strtotime($CIE_OPEN_J2_H3)-strtotime($CIE_OPEN_J2_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J2_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J2_H2,0,5); if (strtotime($CIE_OPEN_J2_H3)-strtotime($CIE_OPEN_J2_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J2_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J2_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Wednesday</td><td <?php if ($CIE_OPEN_J3_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J3_EN;} else if ((strtotime($CIE_OPEN_J3_H1)-strtotime($CIE_OPEN_J3_H2)>=0) && (strtotime($CIE_OPEN_J3_H3)-strtotime($CIE_OPEN_J3_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J3_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J3_H2,0,5); if (strtotime($CIE_OPEN_J3_H3)-strtotime($CIE_OPEN_J3_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J3_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J3_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Thursday</td> <td <?php if ($CIE_OPEN_J4_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J4_EN;} else if ((strtotime($CIE_OPEN_J4_H1)-strtotime($CIE_OPEN_J4_H2)>=0) && (strtotime($CIE_OPEN_J4_H3)-strtotime($CIE_OPEN_J4_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J4_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J4_H2,0,5); if (strtotime($CIE_OPEN_J4_H3)-strtotime($CIE_OPEN_J4_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J4_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J4_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Friday</td>   <td <?php if ($CIE_OPEN_J5_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J5_EN;} else if ((strtotime($CIE_OPEN_J5_H1)-strtotime($CIE_OPEN_J5_H2)>=0) && (strtotime($CIE_OPEN_J5_H3)-strtotime($CIE_OPEN_J5_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J5_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J5_H2,0,5); if (strtotime($CIE_OPEN_J5_H3)-strtotime($CIE_OPEN_J5_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J5_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J5_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Saturday</td> <td <?php if ($CIE_OPEN_J6_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J6_EN;} else if ((strtotime($CIE_OPEN_J6_H1)-strtotime($CIE_OPEN_J6_H2)>=0) && (strtotime($CIE_OPEN_J6_H3)-strtotime($CIE_OPEN_J6_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J6_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J6_H2,0,5); if (strtotime($CIE_OPEN_J6_H3)-strtotime($CIE_OPEN_J6_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J6_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J6_H4,0,5); }} ?></td></tr>
                        <tr><td style='vertical-align:top;text-align:left;' width='*'>Sunday</td>   <td <?php if ($CIE_OPEN_J0_EN) {echo "colspan='6' style='text-align:center;'>".$CIE_OPEN_J0_EN;} else if ((strtotime($CIE_OPEN_J0_H1)-strtotime($CIE_OPEN_J0_H2)>=0) && (strtotime($CIE_OPEN_J0_H3)-strtotime($CIE_OPEN_J0_H4)>=0)) { echo "colspan='6' style='text-align:center;'>Closed";} else { echo "width='10%'>".substr($CIE_OPEN_J0_H1,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J0_H2,0,5); if (strtotime($CIE_OPEN_J0_H3)-strtotime($CIE_OPEN_J0_H4)<0){ echo "<td width='10%'>". substr($CIE_OPEN_J0_H3,0,5) . "</td><td style='width:15px;'> - </td><td width='10%'>". substr($CIE_OPEN_J0_H4,0,5); }} ?></td></tr>
                </table><br><span style='margin:10px 0px;'>Opening hours may vary during public holidays.</span>
            <?php } ?>
            </div>
        </div>
        <div class='dw3_paragraf' style='width:auto;min-width:210px;padding-top:40px;margin:5px 20px;text-align:left;line-height:1.4em;'>
            <div style='display:inline-block;text-align:left;min-width:200px;'>
            <h3 style='text-align:left;margin-bottom:5px;color:#<?php echo $CIE_COLOR7; ?>;'>Navigation</h3>
            <?php 
                ...
                if ($dw3_result->num_rows > 0) {
                    while($row = $dw3_result->fetch_assoc()) {
                        if ($row["is_in_menu"] == "true"){
                            if ($row["target"] == "page"){
                                if($USER_LANG == "FR"){
                                    echo "<span class='dw3_font'>Ĺ</span><a class='hovera' href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' style='color:#".$CIE_COLOR7."; text-shadow: 1px 1px 2px #222;text-align:center;'>".$row["title"]."</a><br class='br_small'>";
                                }else{
                                    echo "<span class='dw3_font'>Ĺ</span><a class='hovera' href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' style='color:#".$CIE_COLOR7."; text-shadow: 1px 1px 2px #222;text-align:center;'>".$row["title_en"]."</a><br class='br_small'>";
                                }
                            }
                        }
                    }
        ...
        <div class='dw3_paragraf' style='min-width:250px;padding-top:40px;margin:5px 20px;min-width:200px;width:auto;line-height:1.4em; text-shadow: 1px 1px 2px #222;color:#<?php echo $CIE_COLOR7; ?>;'>
            <h3 style='text-align:left;margin-bottom:5px;'><?php if($USER_LANG == "FR"){ echo "Adresse"; }else{echo "Address";} ?></h3>
            &nbsp;<?php echo $CIE_NOM; ?><br class='br_small'>
            &nbsp;<?php echo $CIE_ADR1 . ' ' . $CIE_ADR2; ?><br class='br_small'>
            &nbsp;<?php echo $CIE_VILLE. ', ' . $CIE_PROV; ?><br class='br_small'>
            &nbsp;<?php echo $CIE_PAYS . ', ' . $CIE_CP; ?><br class='br_small'>     
        </div>
        <?php 
