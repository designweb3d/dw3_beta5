<section class="cd-horizontal-timeline">
        ...
        <div class="timeline">
            ...
            <div class="cd-timeline-navigation">
                <a href="#0" class="prev inactive">Prev</a><div style="font-family:Roboto;position:absolute;top:39px;left:15px;font-size:22px;color:#f17144;">&lt;</div>
                <a href="#0" class="next">Next</a><div style="font-family:Roboto;position:absolute;top:39px;right:14px;font-size:22px;color:#f17144;">&gt;</div>
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<li "; if($row_number == 1){ echo " class='selected' ";} echo " data-date='".$data_date."'><p>".$description_trad."<br><img src='".$row["img_link"]."' style='height:200px;width:auto;'>"; if ($row["href"]!=""){ echo "<br><a style='color:#bbb;font-size:20px;max-width:100%;' href='".$row["href"]."' target='_blank'>".$row["href"]." <span style='font-size:15px;'>⏵</span></a>";} echo "</p></li>";
                    }
                }
            ?>
            </ol>
