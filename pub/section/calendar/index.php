...
?>
    <div id='divCAL2' style='margin-bottom:-7px;box-shadow: <?php echo $SECTION_SHADOW; ?>;'>           
        <table class='tblCAL2'>
            ...
            </thead><tbody><tr><td style='height:100px;text-align:center;'>
                    <?php
                        //Janvier
                        ...
                        ORDER BY date_start";
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<div class='dw3_box' onclick=\"getEVENT('".$row['id']."');\" style='cursor:pointer;font-weight:normal;background-color:#e0e0e0;color:#222;margin:5px 2px 5px 2px;'>";
                                        if($USER_LANG == "FR"){
                                        echo  "<h3>".$row['name']. "</h3>";
                            ...
                            echo "</td><td style='height:100px;text-align:center;'>";
                             //Février - February
                            $sql = "SELECT * FROM event
