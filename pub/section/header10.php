<!-- Haut semi-transparent 70px Sticky Flex -->
 <?php if (!isset($TABINDEX)){$TABINDEX=0;} ?>
<div style='height:70px;'>
    <div id="dw3_head" style='background-color:transparent;background-image: linear-gradient(to right, #<?php echo $CIE_COLOR8; ?> , transparent,transparent,transparent,transparent, transparent , #<?php echo $CIE_COLOR8; ?>);'>
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          ...
          <?php 
                if (trim($CIE_NOM_HTML)=="" && $CIE_LOGO3 != ""){
            ?>  <td width="10"> </td>   
                <td width="10%" onclick='dw3_menu_toggle();' style="text-align:left;border:0;padding:0;margin:0;vertical-align:middle;cursor:pointer;color:var(--dw3_menu_color);font-weight:bold;">
        ...
        <?php 
        echo "<script type='text/javascript'>function setSubMenusPos(){".$aftermath."}</script>";
