...
<footer>
    <?php if (!isset($dw3_conn)){header('Location: https://'.$_SERVER["SERVER_NAME"].'/');exit;}?>
        ...
        <div class='dw3_paragraf' style='min-width:200px;width:30%;'>
                ...
                if ($dw3_result->num_rows > 0) {
                    while($row = $dw3_result->fetch_assoc()) {
                        if ($row["is_in_menu"] == "true"){
                            if ($row["target"] == "page"){
                                if($USER_LANG == "FR"){
                                    echo "&#8594;<a href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' style='color:#".$CIE_COLOR7.";font-weight:bold; text-shadow: 1px 1px 2px #222;text-align:center;'>".$row["title"]."</a><br class='br_small'>";
                                }else{
                                    echo "&#8594;<a href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' style='color:#".$CIE_COLOR7.";font-weight:bold; text-shadow: 1px 1px 2px #222;text-align:center;'>".$row["title_en"]."</a><br class='br_small'>";
                                }
                            }
                        }
                    }
        ...
        <div class='dw3_paragraf' style='min-width:200px;width:30%;font-weight:bold; text-shadow: 1px 1px 2px #222;color:#<?php echo $CIE_COLOR7; ?>;'>
            <h3 style='text-align:left;margin-bottom:5px;'><?php if($USER_LANG == "FR"){ echo "Adresse"; }else{echo "Address";} ?></h3>
            &nbsp;<b><?php echo $CIE_NOM; ?><br class='br_small'></b>
            &nbsp;<?php echo $CIE_ADR1 . ' ' . $CIE_ADR2; ?><br class='br_small'>
            &nbsp;<?php echo $CIE_VILLE. ', ' . $CIE_PROV; ?><br class='br_small'>
            &nbsp;<?php echo $CIE_PAYS . ', ' . $CIE_CP; ?><br class='br_small'><br>
            &nbsp;<b style='font-size:1.4em;'><?php echo $CIE_TEL1; if (trim($CIE_TEL2) != ""){ echo " | " . $CIE_TEL2;} ?></b><br class='br_small'>
            &nbsp;<b><?php echo $CIE_EML1; ?></b>      
        </div>
        <iframe src="<?php echo $CIE_GOOGLE_MAP; ?>" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <?php 
