    ...
    <table style='width:100%;text-align:center;max-width:2800px;margin-right:auto;margin-left:auto;margin-bottom:0px;border-collapse: collapse;'><tr>
        ...
        <?php 
            ...
            if($USER_LANG == "FR"){ 
                ...
                $button_text = $SECTION_TITLE_EN;
            }
        ?>
        </b></span></td>
        <td  style='vertical-align:middle;'><button onclick='window.open("/pub/page/quiz/index.php?P1=<?php echo $PAGE_P1; ?>","_self")'  style='padding:10px 25px;float:right;margin:20px;'><?php echo $button_text; ?></button></td>
    </tr></table>
</div>