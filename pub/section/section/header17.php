<!-- Avec entête text défilant 30 + 70px -> 70px Sticky -->
 <?php if (!isset($TABINDEX)){$TABINDEX=0;} ?>
    <div style="position:relative;z-index:350;width:100%;background-color:#<?php echo $CIE_COLOR8; ?>;color:#<?php echo $CIE_COLOR9; ?>;font-family:<?php echo $CIE_FONT3??'Roboto';?>;text-align:center;height:30px;max-height:30px;overflow:hidden;">
        <div id="scroll-container">
            <div id="scroll-text"><?php if ($USER_LANG == "FR"){echo $INDEX_TOP_FR;}else{echo $INDEX_TOP_EN;}?></div>
        </div>
    </div>
    ...
    <div id="dw3_head" style="border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;">
        ...
        <?php 
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            ...
                            echo "<div class='dw3_wide_view_menu' style='padding:10px;flex-direction:row;vertical-align:middle!important;text-align:center;'><a href='#dw3_section_".$x_s."' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></div>";
            ...
            <td width="10" class='dw3_wide_view_menu'> 
            </td>
        </tr></table>
