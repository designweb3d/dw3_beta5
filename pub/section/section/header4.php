<!-- Sans redimension +contacts 100px  Sticky -->
...
<div style='height:100px;'>
    <div id="dw3_head"   style="border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;max-height:100px;height:100px;"">
        <div id='dw3_h3_tel1' style='<?php if ($CIE_TEL1 == "") { echo "display:none;"; } ?>transition: all 1s;position:absolute;top:-2px;left:260px;' class='dw3_wide_view_menu'><span class="material-icons"  style='font-size:19px;-webkit-filter: invert(100%);filter: invert(100%);'>call</span> <a <?php if ($CIE_TEL1 != "") { $TABINDEX++; echo "tabindex='".$TABINDEX."'"; } ?> href='tel://<?php echo $CIE_TEL1; ?>' style='font-size:14px;color:#<?php echo $CIE_COLOR9; ?>;font-family:Roboto;'><?php echo $CIE_TEL1; ?></a> </div> 
        <div id='dw3_h3_eml1' style='<?php if ($CIE_EML1 == "") { echo "display:none;"; } ?>transition: all 1s;position:absolute;top:-2px;right:50px;' class='dw3_wide_view_menu'><span class="material-icons"  style='font-size:19px;-webkit-filter: invert(100%);filter: invert(100%);'>mail</span> <a <?php if ($CIE_EML1 != "") { $TABINDEX++; echo "tabindex='".$TABINDEX."'"; } ?> href='mailto://<?php echo $CIE_EML1; ?>' style='font-size:14px;color:#<?php echo $CIE_COLOR9; ?>;font-family:Roboto;'><?php echo $CIE_EML1; ?></a> </div>
        <table  style='font-family:var(--dw3_menu_font);border-spacing:0px;table-layout: fixed;border-collapse: collapse;border:0;padding:0;'>
          <tr id='dw3_head_row' style='transition: all 1s;height:100px;max-height:100px;border:0;padding:0;margin:0;'>
            <td width="*" onclick='dw3_menu_toggle();' style="vertical-align:top;text-align:left;cursor:pointer;color:#66c6dd;font-weight:bold;">
            <?php 
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            if (substr($row["url"],0,10)=="/pub/page/" || $row["url"] == "/" || $row["url"] == ""){
                                ...
                                echo "<td class='dw3_wide_view_menu' style='padding-top:5px;vertical-align:middle!important;text-align:center;'><a href='".$row["url"]."' target='_self' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                            }
                        } else if ($row["target"] == "sub" &&  $row["is_in_menu"] == "true"){
                            echo "<td class='dw3_wide_view_menu' style='padding-top:5px;vertical-align:middle!important;text-align:center;' onmouseover=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onmouseout=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"dw3_sub_menu_toggle('dw3_sub".$row["id"]."',1000)\"><a style='color:#".$CIE_COLOR9.";' class='no_underline' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad." <span style='font-size:14px;'>&#11206;</span></a><br class='br_small'>";
                            //sub-menu
