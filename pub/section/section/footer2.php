...
<footer>
    <?php if (!isset($dw3_conn)){header('Location: https://'.$_SERVER["SERVER_NAME"].'/');exit;}?>
        ...
        <div style="margin:10px 0px;z-index:+1;position:absolute;right:0px;font-size:0.8em;display:inline-block;height:2vw;min-height:40px;overflow:hidden;text-align:right;">
        <?php 
        ...
        <div style='margin-top:10px;display:inline-block;vertical-align:middle;width:auto;text-align:center;'>
        ...
        <div class='dw3_paragraf' style='vertical-align:middle;width:auto;margin:10px 40px;'>
            <h3 style='text-align:left;margin-bottom:5px;color:#<?php echo $CIE_COLOR7; ?>;'><?php echo $CIE_NOM; ?></h3>
            <?php 
                ...
                if ($dw3_result->num_rows > 0) {
                    while($row = $dw3_result->fetch_assoc()) {
                        if ($row["is_in_menu"] == "true"){
                            if ($row["target"] == "page"){
                                if($USER_LANG == "FR"){
                                    echo "&#8594;<a class='hovera' href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' style='color:#".$CIE_COLOR7.";font-weight:bold; text-shadow: 1px 1px 2px #222;text-align:center;'>".$row["title"]."</a><br class='br_small'>";
                                }else{
                                    echo "&#8594;<a class='hovera' href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' style='color:#".$CIE_COLOR7.";font-weight:bold; text-shadow: 1px 1px 2px #222;text-align:center;'>".$row["title_en"]."</a><br class='br_small'>";
                                }
                            }
                        }
                    }
