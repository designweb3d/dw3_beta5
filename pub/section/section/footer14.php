...
<!-- footer secured by sectigo avec lien -->
<footer>
    ...
    <div class='dw3_page_foot'>
        ...
        if ($CIE_COOKIES_IMG == ""){ 
            ...
            echo "' style='cursor:pointer;position:absolute;left:5px;width:40px;height:auto;z-index:+1;' src='/pub/img/cookies/". $CIE_COOKIES_IMG."' onclick='dw3_cookie_pref();'>";
        }
        ?>
