<!-- Avec redimension et contacts texte bas 100px -> 70px Sticky -->
 <?php if (!isset($TABINDEX)){$TABINDEX=0;} ?>
<div style='height:100px;'>
    <div id="dw3_head" style="border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;max-height:100px;height:100px;">
        <div style='position:absolute;top:0px;right:30px;'><div id='dw3_h3_tel1' style='<?php if ($CIE_TEL1 == "") { echo "display:none;"; } ?>transition: all 1s;' class='dw3_wide_view_menu'><span class="material-icons"  style='font-size:19px;color:#<?php echo $CIE_COLOR9; ?>;'>call</span> <a <?php if ($CIE_TEL1 != "") { $TABINDEX++; echo "tabindex='".$TABINDEX."'"; } ?> href='tel://<?php echo $CIE_TEL1; ?>' style='font-size:14px;color:#<?php echo $CIE_COLOR9; ?>;font-family:Roboto;'><?php echo $CIE_TEL1; ?></a> </div> <div id='dw3_h3_eml1' style='<?php if ($CIE_EML1 == "") { echo "display:none;"; } ?>transition: all 1s;' class='dw3_wide_view_menu'><span class="material-icons"  style='margin-left:30px;font-size:19px;color:#<?php echo $CIE_COLOR9; ?>;'>mail</span> <a <?php if ($CIE_EML1 != "") { $TABINDEX++; echo "tabindex='".$TABINDEX."'"; } ?> href='mailto://<?php echo $CIE_EML1; ?>' style='font-size:14px;color:#<?php echo $CIE_COLOR9; ?>;font-family:Roboto;'><?php echo $CIE_EML1; ?></a> </div></div>
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          <tr id='dw3_head_row' style='transition: all 1s;height:100px;max-height:100px;border:0;padding:0;margin:0;'>
            <td id='header3_img' onclick='dw3_menu_toggle();' style="vertical-align:top;text-align:left;cursor:pointer;color:#66c6dd;font-weight:bold;transition: all 1s ease-in-out;">
                <img id="imgLOGO" src="/pub/img/<?php echo $CIE_LOGO3; ?>" style="padding:0px;vertical-align:top;height:100px;max-width:220px;width:auto;transition: all 1s;" alt="Logo de l'entreprise pour le site web">
            </td>
                <?php
                $aftermath='';
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            if (substr($row["url"],0,10)=="/pub/page/" || $row["url"] == "/" || $row["url"] == ""){
                                if ($PAGE_ID == $row["id"] || $PAGE_ID == "0" && $row["url"] == "/" || $PAGE_ID == "" && $row["url"] == "/"){
                                    echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:35px;vertical-align:middle!important;text-align:center;'><a href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' target='_self' style='color:#".$CIE_COLOR9.";text-decoration: underline;' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                                } else {
                                    echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:35px;vertical-align:middle!important;text-align:center;'><a href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' target='_self' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                                }
                            }else{
                                echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:35px;vertical-align:middle!important;text-align:center;'><a href='".$row["url"]."' target='_self' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                            }
                        } else if ($row["target"] == "sub" &&  $row["is_in_menu"] == "true"){
                            echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:35px;vertical-align:middle!important;text-align:center;' onmouseover=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onmouseout=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"dw3_sub_menu_toggle('dw3_sub".$row["id"]."',1000)\"><a onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',600)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',600)\" style='color:#".$CIE_COLOR9.";' class='no_underline' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad." <span style='font-size:14px;'>&#11206;</span></a><br class='br_tiny'>";
                            //sub-menu
                            ...
                            if ($result2->num_rows > 0) {
                                ...
                                while($row2 = $result2->fetch_assoc()) {
                                    ...
                                    if (substr($row2["url"],0,10)=="/pub/page/"){
                                        echo "<button tabindex='".$TABINDEX."' onclick=\"window.open('".$row2["url"]."?PID=".$row2["id"]."&P1=".$row2["cat_list"]."','_self');\" style='white-space:normal;padding:10px;margin:1px 0px;width:97%;max-max-width:350px;display:inline-block;' onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',600)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',600)\">".$title_trad."</button><br class='br_tiny'>";
                                    }else{
                                        echo "<button tabindex='".$TABINDEX."' onclick=\"window.open('".$row2["url"]."','_self');\" style='white-space:normal;padding:10px;margin:1px 0px;width:97%;max-max-width:350px;display:inline-block;' onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',600)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',600)\">".$title_trad."</button><br class='br_tiny'>";
                                    }
                                }
                                echo "</div>";
                                ...
                                //$aftermath .= "\n if (document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth<160) {document.getElementById('dw3_sub".$row["id"] ."').style.left -= (80-document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth/2)+'px'; alert(document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth);}  ";
                                //$aftermath .= "\n document.getElementById('dw3_sub".$row["id"] ."').style.width = document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth + 'px'; ";
                                //$aftermath .= "\n if (document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth>152) {document.getElementById('dw3_sub".$row["id"] ."').style.width = document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth+'px';document.getElementById('dw3_sub".$row["id"] ."').style.marginLeft='-6px';}else{document.getElementById('dw3_sub".$row["id"] ."').style.width='152px';document.getElementById('dw3_sub".$row["id"] ."').style.marginLeft='-'+(152-(document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth)+10).toString()+'px';} "; //(document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth/2)$aftermath .= "\n if (document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth>152) {document.getElementById('dw3_sub".$row["id"] ."').style.width = document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth+'px';}else{document.getElementById('dw3_sub".$row["id"] ."').style.width='152px';document.getElementById('dw3_sub".$row["id"] ."').style.marginLeft='-'+((152-document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth+20)/2).toString()+'px';} "; //(document.getElementById('dw3_sub".$row["id"] ."').parentElement.offsetWidth/2)
...
/*                                     $aftermath .= "\n 
                ...
                if ($INDEX_DSP_LANG=="true"){ $TABINDEX++; if ($USER_LANG == "FR"||$USER_LANG == ""){ ?>
                    <td width="30" tabindex='<?php echo $TABINDEX;?>' onclick="dw3_lang_set('EN');" style="padding-top:35px;vertical-align:middle!important;text-align:center;cursor:pointer;"> 
                    ...
                    <?php } else {
                    ?>
                    <td width="30" tabindex='<?php echo $TABINDEX;?>' onclick="dw3_lang_set('FR');" style="padding-top:35px;vertical-align:middle!important;text-align:center;cursor:pointer;"> 
            ...
            <?php } ?><td width="10"> </td>
            <td id='dw3_small_view_menu' onclick='dw3_menu_toggle();' style="padding:35px 0px 0px 10px;vertical-align:middle!important;text-align:center;cursor:pointer;">
