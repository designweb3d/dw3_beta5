<!-- Avec entête contact 50 +70px -> 70px Sticky -->
 <?php if (!isset($TABINDEX)){$TABINDEX=0;} ?>
    <div style="position:relative;z-index:350;width:100%;background-color:#<?php echo $CIE_COLOR6; ?>;color:#<?php echo $CIE_COLOR7; ?>;font-family:<?php echo $CIE_FONT3??'Roboto';?>;text-align:center;height:50px;max-height:50px;overflow:hidden;">
    <table style="text-align:left;width:100%;height:50px;">
            <tbody><tr>
                <?php if ($CIE_TEL1 != "") { ?>
                <td style="padding:5px;text-align:center;vertical-align:middle;line-height:1;">
                    <a href="tel:<?php echo $CIE_TEL1; ?>" style="color:#<?php echo $CIE_COLOR7; ?>;font-size:0.8em;" target="_blank"><span class="material-icons" style="font-size:1em;vertical-align:middle;color:#<?php echo $CIE_COLOR7; ?>;">call</span> <?php echo $CIE_TEL1; ?></a>
                </td>
                <?php } else { ?>
                    ...
                    <?php }
                    ?>
                <td style="white-space:no-wrap;vertical-align:middle;padding:5px;color:#fff;text-align:center;line-height:1;">
                    <a href="mailto:<?php echo $CIE_EML1; ?>" style="font-size:0.8em;color:#<?php echo $CIE_COLOR7; ?>;"><span class="material-icons" style="font-size:1em;vertical-align:middle;color:#<?php echo $CIE_COLOR7; ?>;">mail </span> <?php echo $CIE_EML1; ?></a>
                </td>
            </tr>
        </tbody></table>
    </div>
<div style='height:70px;position:sticky;top:0;z-index:350;'>
    <div id="dw3_head" style="position:sticky;top:0;border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;">
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                                ...
                                echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:5px;vertical-align:middle!important;text-align:center;' onmouseover=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onmouseout=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"dw3_sub_menu_toggle('dw3_sub".$row["id"]."',1000)\"><a onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" style='color:#".$CIE_COLOR9.";' class='no_underline' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad." <span style='font-size:14px;'>&#11206;</span></a><br class='br_small'>";
                                //sub-menu
                                ...
                                if ($result2->num_rows > 0) {
                                    ...
                                    while($row2 = $result2->fetch_assoc()) {
                                        ...
                                        if (substr($row2["url"],0,10)=="/pub/page/"){
                                            echo "<button onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"window.open('".$row2["url"]."?PID=".$row2["id"]."&P1=".$row2["cat_list"]."','_self');\" style='white-space: normal;padding:10px;margin:1px;max-width:350px;display:inline-block;'>".$title_trad."</button><br class='br_tiny'>";
                                        }else{
                                            echo "<button onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"window.open('".$row2["url"]."','_self');\" style='white-space:normal;padding:10px;max-width:350px;margin:1px;display:inline-block;'>".$title_trad."</button><br class='br_tiny'>";
                                        }
                                    }
                                    echo "</div>";
