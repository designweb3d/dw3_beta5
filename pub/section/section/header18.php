<!-- Avec redimension texte haut 90px -> 70px Sticky -->
 <?php if (!isset($TABINDEX)){$TABINDEX=0;} ?>
<div style='height:90px;'>
    <div id="dw3_head" style="position:fixed;top:0;left:0;border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;max-height:90px;height:90px;">
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          <tr id='dw3_head_row' style='transition: all 1s;height:90px;max-height:90px;border:0;padding:0;margin:0;'>
            <td id='header3_img' onclick='dw3_menu_toggle();' style="vertical-align:top;text-align:left;cursor:pointer;color:#66c6dd;font-weight:bold;transition: all 1s ease-in-out;">
                <img id="imgLOGO" src="/pub/img/<?php echo $CIE_LOGO3; ?>" style="padding:0px;vertical-align:top;height:90px;width:auto;transition: all 1s;" alt="Logo de l'entreprise pour le site web">
            </td>
                <?php
                $aftermath='';
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            if (substr($row["url"],0,10)=="/pub/page/" || $row["url"] == "/" || $row["url"] == ""){
                                if ($PAGE_ID == $row["id"] || $PAGE_ID == "0" && $row["url"] == "/" || $PAGE_ID == "" && $row["url"] == "/"){
                                    echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:10px;vertical-align:top!important;text-align:center;'><a href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' target='_self' style='color:#".$CIE_COLOR9.";text-decoration: underline;' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                                } else {
                                    echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:10px;vertical-align:top!important;text-align:center;'><a href='".$row["url"]."?PID=".$row["id"]."&P1=".$row["cat_list"]."' target='_self' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                                }
                            }else{
                                echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:10px;vertical-align:top!important;text-align:center;'><a href='".$row["url"]."' target='_self' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></td>";
                            }
                        } else if ($row["target"] == "sub" &&  $row["is_in_menu"] == "true"){
                            echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:10px;vertical-align:top!important;text-align:center;' onmouseover=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onmouseout=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"dw3_sub_menu_toggle('dw3_sub".$row["id"]."',1000)\"><a onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" style='color:#".$CIE_COLOR9.";' class='no_underline' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad." <span style='font-size:14px;'>&#11206;</span></a><br class='br_tiny'>";
                            //sub-menu
...
/*                                     $aftermath .= "\n 
                ...
                if ($INDEX_DSP_LANG=="true"){ $TABINDEX++; if ($USER_LANG == "FR"||$USER_LANG == ""){ ?>
                    <td width="30" tabindex='<?php echo $TABINDEX;?>' onclick="dw3_lang_set('EN');" style="padding-top:10px;vertical-align:top!important;text-align:center;cursor:pointer;"> 
                    ...
                    <?php } else {
                    ?>
                    <td width="30" tabindex='<?php echo $TABINDEX;?>' onclick="dw3_lang_set('FR');" style="padding-top:10px;vertical-align:top!important;text-align:center;cursor:pointer;"> 
            ...
            <?php } ?><td width="10"> </td>
            <td id='dw3_small_view_menu' onclick='dw3_menu_toggle();' style="padding:7px 10px 0px 10px;vertical-align:middle!important;text-align:right;cursor:pointer;">
