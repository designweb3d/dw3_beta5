<!-- Minimal Haut avec redimension 100px -> 70px Sticky -->
    ...
    <div id="dw3_head" style="position:fixed;top:0;left:0;border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;max-height:100px;height:100px;">
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          <tr id='dw3_head_row' style='transition: all 1s;height:100px;max-height:100px;border:0;padding:0;margin:0;'>
            <td id='header3_img' onclick='dw3_menu_toggle();' style="vertical-align:top;text-align:left;cursor:pointer;color:#66c6dd;max-width:220px;font-weight:bold;transition: all 1s ease-in-out;">
