<!-- Haut sans entête 2 70px Sticky -->
    ...
    <div id="dw3_head" style='height:auto;max-height:none;min-height:60px;position:fixed;top:0px;left:0px;width:100%;'>
        ...
        <tr style='height:70px;max-height:70px;border:0;padding:0;margin:0;'>
          <?php 
            ...
            ?>  <td width="10"> </td>    
                <td onclick='dw3_menu_toggle();' style="border:0;padding:0;margin:0;vertical-align:middle;text-align:left;cursor:pointer;color:var(--dw3_menu_color);font-weight:bold;">
            ...
            <?php } else if ($CIE_LOGO3 != ""){ ?>
                <td width="*" onclick='dw3_menu_toggle();' style="min-width:90px;border:0;padding:0;margin:0;vertical-align:middle;text-align:center;cursor:pointer;color:var(--dw3_menu_color);font-weight:bold;">
                    <img id="imgLOGO" src="/pub/img/<?php echo $CIE_LOGO3; ?>" style="padding:0px;vertical-align:middle;height:70px;width:auto;" alt="Logo de l'entreprise pour le site web">
            ...
            <?php 
                ...
                if (trim($CIE_EML1)!=""){$TABINDEX++;
            ?> 
                <td class='dw3_wide_view_menu' style="text-align:right;padding:">
                    <span style="margin-right:10px;color:var(--dw3_menu_color);"><a href="mailto:<?php echo $CIE_EML1; ?>" style="font-size:0.8em;color:var(--dw3_menu_color);"><span class="material-icons" style="font-size:1em;vertical-align:middle;color:var(--dw3_menu_color);">mail</span> <?php echo $CIE_EML1; ?></a></span>
                </td>
            <?php 
            }
                if (trim($CIE_TEL1)!=""){$TABINDEX++;
            ?> 
                <td class='dw3_wide_view_menu' style='vertical-align:middle!important;text-align:center;'>
                    <a href="tel:<?php echo $CIE_TEL1; ?>" style="color:var(--dw3_menu_color);font-size:0.9em;" target="_blank"><span class="material-icons" style="font-size:1em;vertical-align:middle;color:var(--dw3_menu_color);">call</span> <?php echo $CIE_TEL1; ?></a>
                </td>            
                <?php
            } 
        ...
        <div style='font-family:var(--dw3_menu_font);background-color: var(--dw3_menu_background2);text-align:right;border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;'>
            <table style='margin-left:auto;margin-right:auto;width:auto;max-width:100%;table-layout: fixed;border-spacing: 20px 0px;padding:0;'>
            <?php
                $aftermath="";
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            if (substr($row["url"],0,10)=="/pub/page/" || $row["url"] == "/" || $row["url"] == ""){
                                ...
                                echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:5px;vertical-align:middle!important;text-align:center;'><a href='".$row["url"]."' target='_self' style='color:#".$CIE_COLOR9.";'>".$title_trad."</a></td>";
                            } 
                        } else if ($row["target"] == "sub" &&  $row["is_in_menu"] == "true"){
                            echo "<td class='dw3_high_view_link' style='min-width:100px;padding-top:5px;vertical-align:middle!important;text-align:center;' onmouseover=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onmouseout=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"dw3_sub_menu_toggle('dw3_sub".$row["id"]."',1000)\"><a style='color:#".$CIE_COLOR9.";' class='no_underline'>".$title_trad." <span style='font-size:14px;'>&#11206;</span></a><br class='br_small'>";
                            //sub-menu
