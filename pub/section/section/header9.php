    ...
    <div id="dw3_head"  style="position:fixed;top:0;left:0;border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;">
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          ...
          <?php 
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            if (substr($row["url"],0,10)=="/pub/page/" || $row["url"] == "/" || $row["url"] == ""){
                                ...
                                echo "<div class='dw3_wide_view_menu' style='padding:10px 20px;flex-direction:row;vertical-align:middle!important;text-align:center;'><a href='".$row["url"]."' target='_self' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></div>";
                            }
                            ...
                            if ($result2->num_rows > 0) {
                                ...
                                while($row2 = $result2->fetch_assoc()) {
                                    ...
                                    if (substr($row2["url"],0,10)=="/pub/page/"){
                                        ...
                                        echo "<button tabindex='".$TABINDEX."' onclick=\"window.open('".$row2["url"]."','_self');\" style='white-space:normal;padding:10px;width:350px;margin:1px 0px;display:inline-block;' onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\">".$title_trad."</button><br class='br_tiny'>";
                                    }
                                }
                                echo "</div>";
                            ...
                            echo "<div class='dw3_wide_view_menu' style='padding:10px 20px;flex-direction:row;vertical-align:middle!important;text-align:center;'><a href='#dw3_section_".$x_s."' style='color:#".$CIE_COLOR9.";' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad."</a></div>";
            ...
            <?php } ?>
            <td width="40" tabindex='<?php echo $TABINDEX;?>' onclick='dw3_lang_open();' style="display:none;padding-right:10px;vertical-align:middle;text-align:center;cursor:pointer;"> 
