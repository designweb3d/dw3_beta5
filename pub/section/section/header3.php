<!-- Avec redimension et contacts 100px -> 70px  Sticky -->
        ...
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          <tr id='dw3_head_row' style='transition: all 1s;height:100px;max-height:100px;border:0;padding:0;margin:0;'>
            <td id='header3_img' onclick='dw3_menu_toggle();' style="vertical-align:top;text-align:left;cursor:pointer;color:#66c6dd;font-weight:bold;transition: all 1s ease-in-out;">
                <img id="imgLOGO" src="/pub/img/<?php echo $CIE_LOGO3; ?>" style="padding:0px;vertical-align:top;height:100px;width:auto;max-width:220px;transition: all 1s;" alt="Logo de l'entreprise pour le site web">
            </td>
                <?php
                $aftermath='';
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["target"] == "page" &&  $row["is_in_menu"] == "true"){
                            ...
                            echo "<td class='dw3_wide_view_menu' style='min-width:100px;padding-top:5px;vertical-align:middle!important;text-align:center;' onmouseover=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onmouseout=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" onclick=\"dw3_sub_menu_toggle('dw3_sub".$row["id"]."',1000)\"><a onfocus=\"dw3_sub_menu_open('dw3_sub".$row["id"]."',1000)\" onblur=\"dw3_sub_menu_close('dw3_sub".$row["id"]."',1000)\" style='color:#".$CIE_COLOR9.";' class='no_underline' arial-label='".$title_trad."' tabindex='".$TABINDEX."'>".$title_trad." <span style='font-size:14px;'>&#11206;</span></a><br class='br_tiny'>";
                            //sub-menu
...
/*                                     $aftermath .= "\n 
            ...
            <?php } ?><td width="10px" style="min-width:10px;max-width:10px;"> </td>
