    ...
    <div id="dw3_head" style="border-top:<?php echo $CIE_COLOR8_3S; ?>px solid #<?php echo $CIE_COLOR8_3; ?>;border-bottom:<?php echo $CIE_COLOR8_4S; ?>px solid #<?php echo $CIE_COLOR8_4; ?>;max-height:100px;height:100px;">
        <table style='font-family:var(--dw3_menu_font);border-spacing:0px;border-collapse: collapse;border:0;padding:0;'>
          <tr id='dw3_head_row' style='transition: all 1s;height:100px;max-height:100px;border:0;padding:0;margin:0;'>
            ...
            <?php } ?><td width="10"> </td>
            <td id='dw3_small_view_menu' onclick='dw3_menu_toggle();' style="display:none;">
                <div id='dw3_menu_bars' style='display:none;'>
                    <div class="dw3_menu_bar1"></div>
                    <div class="dw3_menu_bar2"></div>
                    <div class="dw3_menu_bar3"></div>
                </div>
            </td>
            <td onclick='dw3_menu_toggle();' style="vertical-align:top;text-align:right;cursor:pointer;color:#66c6dd;font-weight:bold;transition: all 1s ease-in-out;">
                <img id="imgLOGO4" src="/pub/img/<?php echo $CIE_LOGO4; ?>" style="padding:0px;vertical-align:top;height:100px;width:auto;transition: all 1s;" alt="Logo systeme de l'entreprise pour le site web">
            </td>
        </tr></table>
    </div>
</div>
