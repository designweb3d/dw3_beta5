...
<footer>
    <?php if (!isset($dw3_conn)){header('Location: https://'.$_SERVER["SERVER_NAME"].'/');exit;}?>
        ...
        <div style="margin:0px 10px 0px 0px;z-index:+1;position:absolute;right:0px;font-size:0.8em;display:inline-block;height:2vw;min-height:40px;overflow:hidden;text-align:right;">
        <?php 
        ...
        <div class='dw3_paragraf' style='width:auto;'>
