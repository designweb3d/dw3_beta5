<!-- Haut avec entête 102px -> 70px Sticky -->
 <?php if (!isset($TABINDEX)){$TABINDEX=0;} ?>
    <div style="position:relative;z-index:350;width:100%;line-height:1;background-color:#<?php echo $CIE_COLOR6; ?>;color:#<?php echo $CIE_COLOR7; ?>;font-family:<?php echo $CIE_FONT3??'Roboto';?>;text-align:center;max-height:25px;height:29px;overflow:hidden;font-size:22px;padding-top:7px;overflow:hidden;">
