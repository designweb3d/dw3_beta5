...
function getEVENT(ID) {
	...
	xmlhttp.onreadystatechange = function() {
	  if (this.readyState == 4 && this.status == 200) {
        ...
        if (jsonEVENT[0].href !=""){
            if(LANG=="FR"){
                dw3_msg_open("<h3>"+jsonEVENT[0].name_fr+"</h3>"+jsonEVENT[0].description + "<br style='margin:0;'><a href='"+jsonEVENT[0].href+"' target='_blank'><button>&#128712; Plus d'informations</button></a>"
                    +" <button onclick=\"dw3_msg_close();\">&#10060; Fermer</button>");
            }else{
                dw3_msg_open("<h3>"+jsonEVENT[0].name_en+"</h3>"+jsonEVENT[0].description_en + "<br style='margin:0;'><a href='"+jsonEVENT[0].href+"' target='_blank'><button>&#128712; More informations</button></a>"
                    +" <button onclick=\"dw3_msg_close();\">&#10060; Close</button>");
            }
        } else {
            if(LANG=="FR"){
                dw3_msg_open("<h3>"+jsonEVENT[0].name_fr+"</h3>"+jsonEVENT[0].description + "<br style='margin:0;'> <button onclick=\"dw3_msg_close();\">&#11199; Fermer</button>");
            }else{
                dw3_msg_open("<h3>"+jsonEVENT[0].name_en+"</h3>"+jsonEVENT[0].description_en + "<br style='margin:0;'> <button onclick=\"dw3_msg_close();\">&#11199; Close</button>");
            }
            }
        //getDISPO();
	  }
...
function setCD(id,cdate){
			...
			document.getElementById(id).innerHTML = "&#8987; <b>" + days + "</b>j <b>" + hours + "</b>h <b>" + minutes + "</b>m <b>" + seconds + "</b>s ";
