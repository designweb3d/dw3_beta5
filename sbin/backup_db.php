...
$backup_name        = $_SERVER['DOCUMENT_ROOT']."/backup_db_".$_SERVER['SERVER_NAME']."_".$file_time.".sql";
$tables             = array("config","customer","event","gl","gls","index_head","index_line","invoice_head",
   ...
   //or add 5th parameter(array) of specific tables:    array("mytable1","mytable2","mytable3") for multiple tables
    ...
    function Export_Database($host,$user,$pass,$name,  $tables=false, $backup_name=false )
    {
        ...
        $file_time = date("Y-m-d_H.i.s");
        $backup_name = $backup_name ? $backup_name : "backup_db_".$_SERVER['SERVER_NAME']."_". $file_time .".sql";
