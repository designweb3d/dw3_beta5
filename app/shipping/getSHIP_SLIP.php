...
$html_PDF = "<!DOCTYPE html><html><head><meta charset='utf-8'>
    <title>Ship Slip for " . $name . "</title><meta http-equiv=\"Content-Type\" content=\"text/html\"><link rel=\"shortcut icon\" href=\"/pub/img/favicon.ico\">
        <style>
...
$dw3_conn->close();
$filename = "Ship_Slip_".$head_id.".pdf";
