...
$sql = "INSERT INTO transaction (invoice_id,paid_amount,payment_status,payment_type,created,modified,paid_amount_currency) 
VALUES('" . $ID . "','" .  $AMOUNT . "','succeeded','BANK TRANSFER','".$datetime."','".$datetime."','cad')";
