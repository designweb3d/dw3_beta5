...
$html_PDF = "";
    ...
    if ($qty_lines > 0) {
        ...
        $sql_head="INSERT INTO order_head (location_id,customer_id,stat,ship_type,ship_code,name,company,eml,tel,adr1,adr2,city,prov,country,postal_code,adr1_sh,adr2_sh,city_sh,province_sh,country_sh,postal_code_sh,date_created,date_modified,date_due,date_delivery) " 
...
if (isset($response["payment_link"])){
    ...
    //header("Location: " . $response["payment_link"]["url"]);
